    ...
    <table class="table table-striped table-bordered">
        ...
        ProductsList.map((e,i)=>{
             return(
                ...
                <td> 
                    <button className='btn btn-success' onClick={()=>handleEdit(e)}><i class="fa fa-edit"></i></button>
                    &nbsp;&nbsp;
                    <button class="btn btn-danger" onClick={()=>handleDelete(e.id)}><i class="fa fa-trash"></i></button>
                </td>
                 </tr>
                </>
             )           
